  ...
  return (
    <Layout hideSidebar>
      ...
      <Typography level="body-sm">
        ...
        Zeit zu überarbeiten. Wir werden eine Mitteilung über alle wesentlichen
        Änderungen auf der Website veröffentlichen. Durch Ihre fortgesetzte
      ...
      <Typography level="body-sm" fontWeight="bold">
        ...
        Gewährleistung 'wie gesehen' und 'wie verfügbar' zur Verfügung gestellt.
        Wir lehnen ausdrücklich alle stillschweigenden Gewährleistungen der
        Marktgängigkeit, der Eignung für einen bestimmten Zweck, der
        Nichtverletzung oder der Gewährleistung, dass die Nutzung der Website
        ununterbrochen oder fehlerfrei erfolgt, ab. Sie übernehmen die
        vollständige Verantwortung und das Risiko für Ihre Nutzung der Website.
      </Typography>
      ...
      <Typography level="body-sm" fontWeight="bold">
        ...
        Lizenzgeber oder seine Lieferanten Ihnen oder anderen Personen gegenüber
        unter keinen Umständen und unter keiner Rechtstheorie für indirekte,
        besondere, Neben- oder Folgeschäden jeglicher Art oder einen
        Gesamtbetrag, der (1) 100 CHF oder (2) die Beträge, die Sie in
      ...
      <Typography level="body-sm">
        ...
        besuchen. Beachten Sie bitte, dass die Website nicht für Kinder unter 18
        Jahren bestimmt ist. Durch die Nutzung der Website bestätigen Sie, dass
        Sie mindestens 18 Jahre alt sind. Sie dürfen die Website nicht für
        illegale Aktivitäten nutzen. Es ist untersagt, die Website zu nutzen, um
        unbefugt auf Informationen zuzugreifen. Das Unternehmen behält sich das
        Recht vor, die Website aus beliebigem Grund mit oder ohne Vorankündigung
        zu ändern, auszusetzen oder einzustellen. Das Unternehmen haftet nicht
        für Schäden oder Verluste, die sich daraus ergeben, dass die Website
        Informationen wie persönliche Nachrichten über unverschlüsselte
        Netzwerke wie E-Mail übermittelt. Falls das Unternehmen ein in diesen
        Bedingungen vorgesehenes Recht nicht durchsetzt oder ausübt, stellt dies
        keinen Verzicht auf dieses Recht dar. Sollte eine Bestimmung dieser
        Nutzungsbedingungen ungültig oder nicht durchsetzbar sein, bleiben die
        übrigen Bestimmungen weiterhin gültig. Diese Nutzungsbedingungen sind
        die vollständige Vereinbarung zwischen Ihnen und dem Unternehmen und
        ersetzen alle vorherigen schriftlichen oder mündlichen Vereinbarungen,
        einschließlich früherer Versionen der Nutzungsbedingungen.
      </Typography>
      ...
      <Typography level="body-sm" mt={1}>
        Beispiele für unakzeptable Inhalte oder Verhaltensweisen auf der Website
        sind solche, die wir nach unserem alleinigen Ermessen als Folgendes
        bezeichnen:
      </Typography>
      <List marker={"circle"}>
        {[
      ...
      <Typography level="body-sm" mt={1}>
        ...
        Nutzungsrechte von Personen einzuschränken oder zu widerrufen, wenn sie
        inakzeptable Inhalte veröffentlichen.
      </Typography>
      <Typography level="body-sm" mt={1}>
        ...
        Verpflichtung, Einsendungen in irgendeiner Weise einzuschränken oder zu
        überwachen oder Benutzer zu blockieren, die unangemessene Inhalte
        einreichen.
      </Typography>
      <Typography level="body-sm" mt={1}>
      ...
      <Typography level="body-sm" mt={1}>
        ...
        oder Qualität dieser Inhalte. Sie verstehen, dass Sie durch die Nutzung
        der Website möglicherweise auf Inhalte stoßen, die Sie als beleidigend,
        unanständig, falsch oder anstößig empfinden könnten. Sie stimmen zu,
        dass das Unternehmen unter keinen Umständen für Inhalte haftbar gemacht
        wird, einschließlich etwaiger Fehler oder Auslassungen, und für Verluste
        oder Schäden jeglicher Art, die durch Ihre Nutzung der Inhalte
        entstehen. Wenn Sie anstößige Materialien melden möchten, können Sie für
        jedes Thema oder jede Antwort die Funktion „Zur Überprüfung melden“
        verwenden. Dringende Probleme können an folgende Adresse gemeldet
        werden:{" "}
        <Link href="mailto:urbanswisstionary@gmail.com">
          urbanswisstionary@gmail.com
        </Link>
      ...
      <Typography level="body-sm" mt={1}>
        Sie tragen die alleinige Verantwortung für alle Inhalte, die Sie auf der
        Website veröffentlichen. Sie sind für die Folgen der Veröffentlichung
        dieser Inhalte verantwortlich. Sie erklären sich damit einverstanden,
        das Unternehmen, seine leitenden Angestellten, Direktoren, Mitarbeiter
        und Vertreter von allen Ansprüchen, Verlusten, Kosten,
        Verbindlichkeiten, Schäden, Urteilen, Strafen, Zinsen und Ausgaben
        (einschließlich angemessener Anwaltskosten) zu entschädigen, zu
        verteidigen und schadlos zu halten. Gebühren, die sich aus einer
      ...
      <Typography level="body-sm">
        ...
        allen Elementen davon, einschließlich, aber nicht beschränkt auf Design,
        Grafik, Funktionalität und Dokumentation. Sie dürfen keinen Teil der
        Website, der Eigentum des Unternehmens ist, kopieren, ändern oder
        rückgängig machen. Soweit Sie Wenn Sie Inhalte auf der Website
        ...
        ausgestellt, öffentlich aufgeführt und abgeleitet werden. Dabei ist die
        Form der verwendeten Medien unerheblich. Ob solche Medien oder Dienste
        bereits existieren oder in Zukunft entwickelt werden, ist ungewiss.
        Durch die Veröffentlichung von Inhalten auf der Website erklären und
        garantieren Sie hiermit, dass Sie über alle notwendigen Rechte verfügen,
        um diese Inhalte zu veröffentlichen, und gewähren dem Unternehmen die
        vorstehende Lizenz. Das Unternehmen respektiert das geistige Eigentum
        anderer. Unter geeigneten Umständen kann es erforderlich sein, die
        Konten von Benutzern zu deaktivieren und/oder zu kündigen, die
        wiederholt die Rechte anderer verletzen.
      </Typography>
      <Typography level="body-sm">
      ...
      <Typography level="body-sm">
        ...
        wegen Urheberrechtsverletzungen oder anderen Verletzungen des geistigen
        Eigentums ist per E-Mail unter{" "}
        <Link href="mailto:urbanswisstionary@gmail.com">
          urbanswisstionary@gmail.com
        </Link>{" "}
        erreichbar.
      ...
      <Typography level="body-sm">
        ...
        Muttergesellschaften, Tochtergesellschaften, verbundenen Unternehmen und
        Nachfolger des Unternehmens sind ebenfalls von dieser Haftung
        ausgeschlossen. Beauftragte, Mitarbeiter, Vertreter, Direktoren,
        leitende Angestellte und Aktionäre sind nicht verpflichtet, die Website
        auf unangemessenen Inhalt zu überwachen. Das Unternehmen und seine
        Muttergesellschaften, Tochtergesellschaften, verbundenen Unternehmen,
        Nachfolger, Bevollmächtigte, Mitarbeiter, Vertreter, Direktoren und
        leitenden Angestellten übernehmen keine Verantwortung für die
        Überwachung der Website auf unangemessenen Inhalt. Die Aktionäre
        übernehmen keinerlei Verantwortung oder Haftung für den Inhalt und
        daraus resultierende Ansprüche, einschließlich Verleumdung, Verletzung
        der Privatsphäre und Veröffentlichungsrechte, Obszönität, Pornografie,
        Betrug oder Falschdarstellung.
      </Typography>
      ...
      <Typography level="body-sm">
        ...
        Ideen, originellen kreativen Kunstwerke, Vorschläge oder andere Arbeiten
        („Einsendungen“) in irgendeiner Form zu. Diese Richtlinie dient
        ausschließlich dazu, potenzielle Missverständnisse oder Streitigkeiten
        zu vermeiden, falls die Produkte oder Marketingstrategien von
        ...
        gelten für Ihre Einsendungen unabhängig vom Inhalt Ihres Schreibens die
      ...
      <Typography level="body-sm">
        ...
        verpflichtet ist, die Einreichung zu prüfen; und (4) keine Verpflichtung
        zur Geheimhaltung der eingereichten Beiträge besteht.
      </Typography>
